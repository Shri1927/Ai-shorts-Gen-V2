...
const Topic = ({ onInputChange }) => {
    ...
    return (
        <div>
            ...
            <div className='mt-5'>
                <h2>Video Topic</h2>
                <p className='text-sm text-gray-400'>Selct topic for your video</p>
                    ...
                    <TabsContent value="suggestion">
                        <div>
                            {suggestions.map((suggestion, idx) => (
                                <Button key={idx} variant='outline' className={`m-1 cursor-pointer ${selectedTopic == suggestion && `bg-secondary`}`}
                                    onClick={() => {
                            ...
                            {scripts.map((script, idx) => (
                                <div
                                    ...
                                    onClick={() => {
                                        ...
                                        onInputChange('script', script?.content);
                                    }}
                                    key={idx}
                                >
